    ...
    public function getInterests() {
        return [
            [
                'id' => 'hobby',
                'title' => 'Мое хобби',
                'description' => 'Программирование, чтение книг, видеоигры, фотография, путешествия. Люблю изучать новые технологии и языки программирования за 20 дней до экзамена.'
            ],
            [
                'id' => 'books',
